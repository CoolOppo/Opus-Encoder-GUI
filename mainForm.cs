...
namespace Opus_Encoder_GUI
{
	public partial class MainForm : Form
	{
		...
		void StartConverting()
		{
			...
			opusencProcess.StartInfo.Arguments = "--bitrate" + space + bitrateAdjuster.Value + space + doubleQuote + openFileDialog1.FileName + doubleQuote + space + doubleQuote + Path.GetDirectoryName(openFileDialog1.FileName) + "\\" + Path.GetFileNameWithoutExtension(openFileDialog1.FileName) + ".opus" + doubleQuote;
